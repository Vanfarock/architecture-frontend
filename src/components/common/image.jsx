...
const Image = ({src, description, containerClass, descriptionClass, imageClass, hover=true, ...other}) => {
  ...
  return (
    <div className={`relative group ${containerClass || ''}`}>
      ...
      <img className={formatImageClass()} {...other} src={src} alt={description || "Projeto"}/>
    </div>
  );
};
